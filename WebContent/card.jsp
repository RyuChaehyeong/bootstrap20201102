...
<div class="card mt-5 mx-4 bg-primary text-white">
  <div class="card-body">
    <h4 class="card-title">Card title</h4>
    <p class="card-text">Some example text. Some example text.</p>
    <a href="http://www.naver.com" class="card-link text-light">Card link</a>
    <a href="https://github.com/sebaek" class="card-link text-light">Another link</a>
  </div>
</div>
